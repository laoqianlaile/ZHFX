...
public class VerifyCode {
	...
	// 宋体，华文楷书，黑体，华文新魏，华文隶书，微软雅黑，楷体_GB2312,Times
	private String[] fontNames = { "宋体", "华文楷书", "黑体", "华文新魏", "微软雅黑", "华文隶书", "楷体_GB2312", "Times New Roman" };// 可选的字符
	...
	public BufferedImage getImage() {
		...
		StringBuilder sb = new StringBuilder();// 用来装载生成的验证码文本向图中画4个字符
