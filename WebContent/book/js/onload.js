...
var Book_v7 = {
    ...
    ready: function(){
       ...
       $(window).bind('orientationchange resize', function(event){
        ...
        $("#fb7 #fb7-about").css('width',(WIDTH_BOOK)+'px');
    ...
    media_queries:function (){
       ...
       var xMax_left=position_left+$('#fb7-logo').width();
    ...
    init: function() {
		...
		$('#fb7-book').turn({
			display: 'single',//single,单页显示;double,双页显示
			acceleration: true,
			gradients:true,
			elevation:50,
			page:nrPage,
    ...
    resize_page: function (){
         ...
         //width
         var width=(  (this.widthBook())-( this.widthBook()*0.05  ) )/zoom;
    ...
    $('.fb7-fullscreen').on('click', function() {
     ...
     $('#fb7').fullScreen({
		...
		$('.fb7-zoom-in').on('click', function() {
			var mlscale = scalevalue+0.1;
		    scalevalue+=0.1;
		    $(".mlopenDiv").css("transform","scale("+mlscale+")");
			Book_v7.zoomIn();
		});
