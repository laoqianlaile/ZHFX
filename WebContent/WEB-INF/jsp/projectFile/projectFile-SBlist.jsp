...
<input type="hidden" id="tzgm" value="${filters.tzgm}" />
...
<input type="hidden" id="applyTime" value="${filters.applyTime}" />
<input type="hidden" id="falg" value="${filters.falg}" />
<input type="hidden" id="label" value="${filters.label}" />
...
<script type="text/javascript">
	...
	$(function (){
		...
		project_datagrid = $("#project_datagrid").datagrid({
			fit: true,
			url: "projectFile!showSBProject.action",
			queryParams:{
				...
				'filters.applyTime':$("#applyTime").val(),
				'filters.builPlaceCodeMap':ZHFX.getCookie("BuildPlaceCode"),
				'filters.falg':$("#falg").val(),
				'filters.label':$("#label").val()
			},
			border: true,
