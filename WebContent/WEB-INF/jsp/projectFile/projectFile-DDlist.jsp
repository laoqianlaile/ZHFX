...
<input type="hidden" id="dispatch" value="${filters.dispatch}" />
<input type="hidden" id="status" value="${filters.status}" />
<input type="hidden" id="process" value="${filters.process}" />
...
<input type="hidden" id="endTime" value="${filters.endTime}" />
<input type="hidden" id="wholeProcessPlace" value="${filters.wholeProcessPlace}" />
<input type="hidden" id="majorstrategyName" value="${filters.majorstrategyName}" />
<input type="hidden" id="wnsj" value="${filters.wnsj}" />
<input type="hidden" id="departmentName" value="${filters.departmentName}" />
<input type="hidden" id="projectType" value="${filters.projectType}"/>
<input type="hidden" id="issuedTime" value="${filters.issuedTime}" />
...
<script type="text/javascript">
	...
	$(function (){
		...
		project_datagrid = $("#project_datagrid").datagrid({
			fit: true,
			url: "projectFile!showDDProject.action",
			queryParams:{
				...
				'filters.dispatch':$("#dispatch").val(),
				'filters.status':$("#status").val(),
				'filters.process':$("#process").val(),
				'filters.goverInvestDir':$("#goverInvestDir").val(),
				'filters.GovernmentCode':$("#GovernmentCode").val(),
				'filters.endTime':$("#endTime").val(),
				'filters.wholeProcessPlace':$("#wholeProcessPlace").val(),
				'filters.majorstrategyName':$("#majorstrategyName").val(),
				'filters.wnsj':$("#wnsj").val(),
				'filters.departmentName':$("#departmentName").val(),
				'filters.projectType':$("#projectType").val(),
				'filters.issuedTime':$("#issuedTime").val(),
...
// 		$("#yearApplyStartTime").datebox("clear");   //年度计划申报日期1
// 		$("#yearApplyEndTime").datebox("clear");     //年度计划申报日期2
// 		$("#specialStartTime").datebox("clear");     //专项建设基金申报日期1
// 		$("#specialEndTime").datebox("clear");       //专项建设基金申报日期2
// 		$("#centSizeL").numberbox("clear");      	   //中央预算内申请规模1
// 		$("#centSizeR").numberbox("clear");      	   //中央预算内申请规模2
// 		$("#specialSizeL").numberbox("clear");   	   //专项建设基金申请规模1
// 		$("#specialSizeR").numberbox("clear");   	   //专项建设基金申请规模2
// 		$("#specialReqSizeL").numberbox("clear");    //专项建设基金需求规模1
// 		$("#specialReqSizeR").numberbox("clear");    //专项建设基金需求规模2
// 		$("#centerReqSizeL").numberbox("clear");     //中央预算内需求规模1
// 		$("#centerReqSizeR").numberbox("clear");     //中央预算内需求规模2
...
// 			 "paramsMap.projectImplePro"      :projectImplePro,
...
// 			 "paramsMap.yearPlanRepTime1"     :yearPlanRepTime1,
// 			 "paramsMap.yearPlanRepTime2"     :yearPlanRepTime2,
// 			 "paramsMap.specialRepTime1"      :specialRepTime1,
// 			 "paramsMap.specialRepTime2"      :specialRepTime2,
// 			 "paramsMap.cupApplyBudCaptial1"  :cupApplyBudCaptial1,
// 			 "paramsMap.cupApplyBudCaptial2"  :cupApplyBudCaptial2,
// 			 "paramsMap.cupApplySpeCaptial1"  :cupApplySpeCaptial1,
// 			 "paramsMap.cupApplySpeCaptial2"  :cupApplySpeCaptial2,
// 			 "paramsMap.cupNeedSpeCaptial1"   :cupNeedSpeCaptial1,
// 			 "paramsMap.cupNeedSpeCaptial2"   :cupNeedSpeCaptial2,
// 			 "paramsMap.cupNeedBudCaptial1"   :cupNeedBudCaptial1,
// 			 "paramsMap.cupNeedBudCaptial2"   :cupNeedBudCaptial2,
...
// 			return 0;
// 		}else if(($("#expect_end_year1").combobox('getValue')>$("#expect_end_year2").combobox('getValue'))&& $("#expect_end_year1").combobox('getValue')!=""){
