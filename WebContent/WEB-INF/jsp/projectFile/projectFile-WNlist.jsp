...
<input type="hidden" id="storeLevel" value="${filters.storeLevel}" />
<input type="hidden" id="storeTime" value="${filters.storeTime}" />
...
<script type="text/javascript">
	...
	$(function (){
		...
		project_datagrid = $("#project_datagrid").datagrid({
			fit: true,
			url: "projectFile!showWNProject.action",
			queryParams:{
				...
				'filters.storeLevel':$("#storeLevel").val(),
				'filters.storeTime':$("#storeTime").val(),
