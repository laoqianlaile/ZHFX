						...
						<thead>
							<tr>
								<th field="PROJECTNAME" align="left" width="200" formatter="nameFormatter">项目名称</th>
							  	<th field="INVESTMENTTOTAL" align="center" width="120">总投资（万元）</th>
								<th field="PROJECTTYPE" align="center" width="100">项目类型</th>
								<th field="INDUSTRYCODE" align="center" width="150">所属行业</th>
								<th field="PROJECTREGION" align="center" width="120">建设地点</th>
								<th field="EXPECTSTARTYEAR" align="center" width="120">拟开工年份</th> 
